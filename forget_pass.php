			...
			<div class="container">
				...
				<div class="forget-password-screen-wrap">
					<div class="forget-password-screen-top mt-32">
						<p class="title-sec">Enter the email associated with your account and we'll send an email with instructions to reset your password.</p>
					</div>
