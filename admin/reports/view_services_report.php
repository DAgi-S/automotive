...
$report = new ServicesReport($admin['id']);
...
// Set page title
$pageTitle = "Services Report - " . date('M d, Y', strtotime($startDate)) . " to " . date('M d, Y', strtotime($endDate));
?>
...
<body>
    <div class="container-fluid">
        ...
        <?php echo $report->generateHTML($data); ?>
    </div>
